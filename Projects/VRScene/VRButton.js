class VRButton {
  static createButton(renderer, options) {
    ...
    function showWebXRNotFound() {
      ...
      button.textContent = "当前设备或环境不支持VR";
    }
    ...
    if ("xr" in navigator) {
      ...
      if (window.isSecureContext === false) {
        ...
        message.innerHTML = "VR需要HTTPS"; // TODO Improve message
        message.onclick = () => {
          alert("VR启动需要https支持");
        };
      } else {
        // message.href = 'https://immersiveweb.dev/';
        message.innerHTML = "VR不支持";
        message.onclick = () => {
          alert("当前设备或者环境不支持VR");
        };
      }
